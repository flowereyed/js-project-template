...
lodash__WEBPACK_IMPORTED_MODULE_0___default.a.each([names, otherNames], function(nameGroup) {
    findSuperman(nameGroup);
});
function findSuperman(values) {
    lodash__WEBPACK_IMPORTED_MODULE_0___default.a.find(values, function(name) {
        if (name === 'Clark Kent') {
